...
from Code.DistributedTaskManager import DistributedTaskManager
from Code.GUI.FastText import FastText

from Code.RenderPasses.GlobalIlluminationPass import GlobalIlluminationPass
from Code.RenderPasses.VoxelizePass import VoxelizePass
...
class GlobalIllumination(DebugObject):
        ...
        if idx == 0:
            ...
            if self.debugText is not None:
                self.debugText.setText("GI Grid Center: " + ", ".join(
                    str(round(i, 2)) for i in self.gridPosTemp[0]) + " / GI Frame " + str(self.renderCount))
    ...
    def setup(self):
        ...
        for color in "rgb":
            ...
            tex.setup3dTexture(self.voxelGridResolution, self.voxelGridResolution, self.voxelGridResolution,
                               Texture.TInt, Texture.FR32)
        ...
        self.convertGridTarget.setSize(self.voxelGridResolution * self.slideCount,
        ...
        self.clearGridTarget.setSize(self.voxelGridResolution * self.slideCount,
                                     self.voxelGridResolution * self.slideVertCount)
        if self.pipeline.settings.useDebugAttachments:
        ...
        for i, direction in enumerate(self.directions):
            ...
            tex.setup3dTexture(self.voxelGridResolution, self.voxelGridResolution, self.voxelGridResolution,
                               Texture.TFloat, Texture.FR11G11B10)
        ...
        for i, direction in enumerate(self.directions):
            ...
            texPing.setup3dTexture(self.voxelGridResolution, self.voxelGridResolution, self.voxelGridResolution,
                                   Texture.TFloat, Texture.FR11G11B10)
            ...
            texPong.setup3dTexture(self.voxelGridResolution, self.voxelGridResolution, self.voxelGridResolution,
                                   Texture.TFloat, Texture.FR11G11B10)
        ...
        self.distributeTarget.setSize(self.voxelGridResolution * self.slideCount,
                                      self.voxelGridResolution * self.slideVertCount)
        if self.pipeline.settings.useDebugAttachments:
        ...
        self.voxelSolidTex.setup3dTexture(self.voxelGridResolution, self.voxelGridResolution, self.voxelGridResolution,
        ...
        self.voxelSolidStableTex.setup3dTexture(self.voxelGridResolution, self.voxelGridResolution,
                                                self.voxelGridResolution, Texture.TFloat, Texture.FR16)
