...
from Code.Water.GPUFFT import GPUFFT
...
class WaterManager(DebugObject):
    ...
    def __init__(self):
        ...
        self.combineShader = Shader.loadCompute(Shader.SLGLSL, "Shader/WaterFFT/Combine.compute")
    ...
    def update(self):
        ...
        self.ptaTime[0] = 1 + Globals.clock.getFrameTime() * self.options.timeScale
