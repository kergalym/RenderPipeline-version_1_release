...
class GPUFFT(DebugObject):
    ...
    def _computeWeighting(self):
        ...
        indicesA = [[0 for i in range(self.size)]
                    for k in range(self.log2Size)]
        indicesB = [[0 for i in range(self.size)]
                    for k in range(self.log2Size)]
    ...
    def _prepareAttributes(self):
        ...
        # Horizontal
        for step in range(self.log2Size):
